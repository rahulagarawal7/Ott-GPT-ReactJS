      ...
      {user && (
        <div className="flex w-full justify-between">
          <ul className="flex px-6 gap-4 my-6 text-[12px]  text-white">
            ...
            <li className="hidden md:block">My List</li>
            <button className=" " onClick={handleGPTClicked}>
              {gptSearch ? "Home" : "Search GPT"}
            </button>
          </ul>

          <div className="flex gap-6 my-6 px-4  w-[350px] md:w-[500px] md:justify-evenly justify-end ">
